...
('controleasy-app', null, '$2a$12$sQqnwXjBfvRRC2hLRaeW.OC9TwSU5M/./vnrV6QkG9W4LEq2ot9xq', 'READ,WRITE', 'password,refresh_token', null, null, '21600', '43200', null, null);

INSERT INTO oauth_client_details (`client_id`, `resource_ids`, `client_secret`, `scope`, `authorized_grant_types`, `web_server_redirect_uri`, `authorities`, `access_token_validity`, `refresh_token_validity`, `additional_information`, `autoapprove`) VALUES 
('controleasy-analytics', null, '$2a$12$sQqnwXjBfvRRC2hLRaeW.OC9TwSU5M/./vnrV6QkG9W4LEq2ot9xq', 'READ,WRITE', 'authorization_code', 'http://www.controleasy-app.local:8081', null, '21600', '43200', null, null);
